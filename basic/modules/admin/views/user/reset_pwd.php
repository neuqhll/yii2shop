...
StaticService::includeAppJsStatic("/js/admin/user/reset_pwd.js",app\assets\AdminAsset::className());
?>
<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_user.php",['current' => 'pwd']);?>
