...
StaticService::includeAppJsStatic( "/js/admin/member/index.js",\app\assets\AdminAsset::className() );
?>

<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_member.php", ['current' => 'comment']); ?>
