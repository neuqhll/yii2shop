...
StaticService::includeAppJsStatic("/js/admin/account/index.js",app\assets\AdminAsset::className());
?>

<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_account.php",['current' => 'index']);?>
        <div class="row">
            <div class="col-lg-12">
                <form class="form-inline wrap_search">
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control inline">
                                ...
                                <option value="<?=$_status;?>"
                                    <?php if($search_conditions['status'] == $_status):?>selected <?php endif;?>
                                    > <?=$_title;?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-w-m btn-outline btn-primary pull-right" href="/admin/account/set">
                ...
                <table class="table table-bordered m-t">
                    ...
                    <tr>
                        ...
                        <td><?=$_item['email'];?></td>
                        <td>
                            <a href="<?=UrlService::buildAdminUrl("/account/info",['id'=>$_item['uid']]);?>">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
                            <a class="m-l" href="<?=UrlService::buildAdminUrl("/account/set",['id'=>$_item['uid']]);?>">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ul class="pagination pagination-lg pull-right" style="margin: 0 0 ;">
                            <?php for($_page = 1;$_page <= $pages['total_page'];$_page++):?>
                                ...
                                <?php else:?>
                                    <li>
                                        <a href="<?=UrlService::buildAdminUrl("/account/index",['p'=>$_page]);?>"><?=$_page;?></a>
                                    </li>
                                <?php endif;?>
                            <?php endfor;?>
                        </ul>
