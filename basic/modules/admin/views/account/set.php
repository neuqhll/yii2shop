...
StaticService::includeAppJsStatic("/js/admin/account/set.js",app\assets\AdminAsset::className());
?>
            ...
            <div class="col-lg-12">
                ...
                <div class="form-horizontal m-t m-b">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="password" name="login_pwd" class="form-control"  autocomplete="new-password" placeholder="请输入登录密码~~" value="<?=$info?(ConstantMapService::$default_pwd):''?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
