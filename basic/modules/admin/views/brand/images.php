...
StaticService::includeAppJsStatic("/js/admin/brand/images.js",\app\assets\AdminAsset::className());
?>

<?php echo Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_brand.php",[ 'current' => 'images' ]);?>
<div class="row">
    <div class="col-lg-12">
        <div class="row m-t">
            <div class="col-lg-12">
