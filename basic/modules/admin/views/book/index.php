...
<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_book.php",['current' => 'index']);?>
<div class="row">
            <div class="col-lg-12">
                <form class="form-inline wrap_search">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-w-m btn-outline btn-primary pull-right" href="/admin/book/set">
                ...
                <table class="table table-bordered m-t">
                    ...
                    <tr>
                        ...
                        <td>hadoop,大数据</td>
                        <td>
                            <a  href="/admin/book/info?id=4">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
                            <a class="m-l" href="/admin/book/set?id=4">
                    ...
                    <tr>
                        ...
                        <td>mysql,index</td>
                        <td>
                            <a  href="/admin/book/info?id=3">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
                            <a class="m-l" href="/admin/book/set?id=3">
                                <i class="fa fa-edit fa-lg"></i>
                            </a>
                    ...
                    <tr>
                        ...
                        <td>php</td>
                        <td>
                            <a  href="/admin/book/info?id=2">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
                            <a class="m-l" href="/admin/book/set?id=2">
                                <i class="fa fa-edit fa-lg"></i>
                            </a>
                    ...
                    <tr>
                        ...
                        <td>浪潮,吴军</td>
                        <td>
                            <a  href="/admin/book/info?id=1">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
                            <a class="m-l" href="/admin/book/set?id=1">
                                <i class="fa fa-edit fa-lg"></i>
                            </a>
